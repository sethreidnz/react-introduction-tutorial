...
This might look like magic but all the `onClickOutside` function is doing is abstracting away the logic to create a callback like that and adding it as a callback to my
component class. 
